...
public:
	...
	public:
		...
		// il pre-incremento modifica sè stesso e non ritorna una copia
		iterator& operator++(){
			x += c.get_dx();
			return *this;
		}
		// il post-incremento fa una copia, modifica sé stesso e ritorna la copia
	...
	iterator begin() const{ return iterator(*this, a);}
	iterator end() const{ return iterator(*this, b + get_dx());}
};
